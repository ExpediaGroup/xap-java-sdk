...
class XapClient private constructor(clientConfiguration: XapClientConfiguration) : BaseXapClient("xap", clientConfiguration) {
     ...
     */
    fun execute(operation: GetFeedDownloadUrlOperation): Response<PresignedUrlResponse> {
        return execute<Nothing, PresignedUrlResponse>(operation)
    }
     ...
     */
    fun executeAsync(operation: GetFeedDownloadUrlOperation): CompletableFuture<Response<PresignedUrlResponse>> {
        return executeAsync<Nothing, PresignedUrlResponse>(operation)
    }
