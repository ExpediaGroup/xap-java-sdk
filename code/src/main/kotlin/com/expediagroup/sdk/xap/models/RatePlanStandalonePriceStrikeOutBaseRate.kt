 ...
 */
data class RatePlanStandalonePriceStrikeOutBaseRate(
    ...
    class Builder(
        ...
        fun build(): RatePlanStandalonePriceStrikeOutBaseRate {
            val instance =
                RatePlanStandalonePriceStrikeOutBaseRate(
                    `value` = `value`,
                    currency = currency,
        ...
        private fun validate(instance: RatePlanStandalonePriceStrikeOutBaseRate) {
            val validator =
                Validation
                    .byDefaultProvider()
                    .configure()
