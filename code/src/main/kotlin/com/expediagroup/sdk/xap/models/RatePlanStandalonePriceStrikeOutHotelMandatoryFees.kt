 ...
 */
data class RatePlanStandalonePriceStrikeOutHotelMandatoryFees(
    ...
    class Builder(
        ...
        fun build(): RatePlanStandalonePriceStrikeOutHotelMandatoryFees {
            val instance =
                RatePlanStandalonePriceStrikeOutHotelMandatoryFees(
                    `value` = `value`,
                    currency = currency,
        ...
        private fun validate(instance: RatePlanStandalonePriceStrikeOutHotelMandatoryFees) {
            val validator =
                Validation
                    .byDefaultProvider()
                    .configure()
