 ...
 */
data class RatePlanStandalonePriceStrikeOutTaxesAndFees(
    ...
    class Builder(
        ...
        fun build(): RatePlanStandalonePriceStrikeOutTaxesAndFees {
            val instance =
                RatePlanStandalonePriceStrikeOutTaxesAndFees(
                    `value` = `value`,
                    currency = currency,
        ...
        private fun validate(instance: RatePlanStandalonePriceStrikeOutTaxesAndFees) {
            val validator =
                Validation
                    .byDefaultProvider()
                    .configure()
