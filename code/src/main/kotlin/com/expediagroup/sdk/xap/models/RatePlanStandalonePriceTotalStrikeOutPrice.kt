...
data class RatePlanStandalonePriceTotalStrikeOutPrice(
    ...
    class Builder(
        ...
        fun build(): RatePlanStandalonePriceTotalStrikeOutPrice {
            val instance =
                RatePlanStandalonePriceTotalStrikeOutPrice(
                    `value` = `value`,
                    currency = currency,
        ...
        private fun validate(instance: RatePlanStandalonePriceTotalStrikeOutPrice) {
            val validator =
                Validation
                    .byDefaultProvider()
                    .configure()
