...
data class GetCarsListingsOperationParams(
    ...
    class Builder(
        ...
        @JsonProperty("pickup.radius") private var pickupRadius: kotlin.Int? = null,
        ...
        private fun validateNullity() {
            ...
            if (dropOffTime == null) {
                throw NullPointerException("Required parameter dropOffTime is missing")
            }
        }
    }
    ...
    override fun getQueryParams(): Parameters {
        return Parameters.build {
            ...
            pickupTime?.let {
                append("pickupTime", it.toString())
            }
            dropOffTime?.let {
                append("dropOffTime", it.toString())
            }
            sortType?.let {
