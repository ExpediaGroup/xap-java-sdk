...
public class AvailabilityCalendarsQuickStartScenarioRunner extends ScenarioRunner {

    public static void main(String[] args) {
        Credentials credentials = new BasicAuthCredentials(System.getenv("VRBO_KEY"), System.getenv("VRBO_SECRET"));
        new AvailabilityCalendarsQuickStartScenario(createClient(credentials)).run();
    }
}
