...
public class VrboPropertySearchEndToEndScenario implements VrboScenario {
    ...
    private void cachePropertyLocationFromDownloadUrl(List<String> propertyIds) {
        ...
        Response<PresignedUrlResponse> downloadUrlLocationsResponse = client.execute(new GetFeedDownloadUrlOperation(getPropertyLocationParams));
     ...
     */
    private void cachePropertyLocationFromLocationsFile(String locationsDownloadUrl, List<String> propertyIds) {
        HttpURLConnection connection = null;
        try {
            // Open a connection to the URL
