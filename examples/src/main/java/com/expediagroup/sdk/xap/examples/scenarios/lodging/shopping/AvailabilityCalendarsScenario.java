...
package com.expediagroup.sdk.xap.examples.scenarios.lodging.shopping;

import com.expediagroup.sdk.xap.examples.scenarios.XapScenario;
import com.expediagroup.sdk.xap.examples.services.lodging.shopping.AvailabilityCalendarsService;
 ...
 */
public class AvailabilityCalendarsScenario implements XapScenario {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(AvailabilityCalendarsScenario.class);

  private final AvailabilityCalendarsService availabilityCalendarService =
      new AvailabilityCalendarsService();
  ...
  public void run() {
    ...
    LOGGER.info("============ Running Lodging Availability Calendars Scenario ============");
    ...
    AvailabilityCalendarResponse availabilityCalendars =
        availabilityCalendarService.getAvailabilityCalendars();
