...
import com.expediagroup.sdk.xap.examples.services.lodging.shopping.ListingsService;
 ...
 * applied.
 */
public class ListingsScenario implements XapScenario {

  private static final Logger LOGGER = LoggerFactory.getLogger(ListingsScenario.class);

  private final ListingsService listingsService = new ListingsService();
  ...
  public void run() {
    ...
    LOGGER.info("============ Running Lodging Listings Scenario ============");

    LOGGER.info("========== Executing GetLodgingListingsOperation ==========");

    HotelListingsResponse hotelListingsResponse = listingsService.getListings();
