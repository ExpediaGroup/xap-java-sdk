...
import com.expediagroup.sdk.xap.examples.services.lodging.shopping.QuotesService;
 ...
 */
public class QuotesScenario implements XapScenario {

  private static final Logger LOGGER = LoggerFactory.getLogger(QuotesScenario.class);

  public final QuotesService quotesService = new QuotesService();
  ...
  public void run() {
    ...
    LOGGER.info("============ Running Lodging Quotes Scenario ============");

    LOGGER.info("========== Executing GetLodgingQuotesOperation ==========");

    LodgingQuotesResponse quotesResponse = quotesService.getQuotes();
