...
import com.expediagroup.sdk.xap.model.ActivitiesCountry
import com.expediagroup.sdk.xap.model.ActivitiesGeoLocation
 ...
 * @param geoLocation
 */
@ConsistentCopyVisibility data class ActivitiesLocationOption private constructor(
    ...
    class Builder(
        ...
        fun build(): ActivitiesLocationOption {
            ...
            val instance = ActivitiesLocationOption(
