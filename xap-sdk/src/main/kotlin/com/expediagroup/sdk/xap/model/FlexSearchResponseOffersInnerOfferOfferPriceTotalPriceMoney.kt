 ...
 */
@ConsistentCopyVisibility data class FlexSearchResponseOffersInnerOfferOfferPriceTotalPriceMoney private constructor(
    ...
    class Builder(
        ...
        fun build(): FlexSearchResponseOffersInnerOfferOfferPriceTotalPriceMoney {
            ...
            val instance = FlexSearchResponseOffersInnerOfferOfferPriceTotalPriceMoney(
                `value` = `value`,
                currency = currency,
            )
