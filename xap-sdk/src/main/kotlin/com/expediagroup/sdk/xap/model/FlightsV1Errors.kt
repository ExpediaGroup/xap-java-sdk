...
import com.expediagroup.sdk.xap.model.FlightsV1Error
 ...
 */
@ConsistentCopyVisibility data class FlightsV1Errors private constructor(
    ...
    class Builder(
        private var errors: kotlin.collections.List<FlightsV1Error>? = null,
        private var transactionId: kotlin.String? = null,
    ) {
        fun errors(errors: kotlin.collections.List<FlightsV1Error>) = apply { this.errors = errors }
