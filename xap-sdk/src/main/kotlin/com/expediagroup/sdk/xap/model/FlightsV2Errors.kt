...
import com.expediagroup.sdk.xap.model.FlightsV2Error
 ...
 */
@ConsistentCopyVisibility data class FlightsV2Errors private constructor(
    ...
    class Builder(
        private var errors: kotlin.collections.List<FlightsV2Error>? = null,
        private var transactionId: kotlin.String? = null,
    ) {
        fun errors(errors: kotlin.collections.List<FlightsV2Error>) = apply { this.errors = errors }
