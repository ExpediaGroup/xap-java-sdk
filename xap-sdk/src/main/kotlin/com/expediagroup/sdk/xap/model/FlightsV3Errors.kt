...
import com.expediagroup.sdk.xap.model.FlightsV3Error
 ...
 */
@ConsistentCopyVisibility data class FlightsV3Errors private constructor(
    ...
    class Builder(
        private var errors: kotlin.collections.List<FlightsV3Error>? = null,
        private var transactionId: kotlin.String? = null,
    ) {
        fun errors(errors: kotlin.collections.List<FlightsV3Error>) = apply { this.errors = errors }
