...
import com.expediagroup.sdk.xap.model.LodgingMoney
 ...
 */
@ConsistentCopyVisibility data class LodgingRoomTypePrice private constructor(
    ...
    class Builder(
        ...
        fun build(): LodgingRoomTypePrice {
            val instance = LodgingRoomTypePrice(
                baseRate = baseRate,
