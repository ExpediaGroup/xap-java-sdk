...
class GetCarsListings400Exception(
    code: Int = 400,
...
class GetCarsListings401Exception(
    code: Int = 401,
...
class GetCarsListings403Exception(
    code: Int = 403,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetCarsListings404Exception(
    code: Int = 404,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetCarsListings429Exception(
    code: Int = 429,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetCarsListings503Exception(
    code: Int = 503,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetCarsListings504Exception(
    code: Int = 504,
