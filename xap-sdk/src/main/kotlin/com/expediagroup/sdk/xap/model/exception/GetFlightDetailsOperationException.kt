...
class GetFlightDetails400Exception(
    code: Int = 400,
...
class GetFlightDetails401Exception(
    code: Int = 401,
...
class GetFlightDetails403Exception(
    code: Int = 403,
    val errorResponse: FlightsV3APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightDetails404Exception(
    code: Int = 404,
    val errorResponse: FlightsV3APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightDetails409Exception(
    code: Int = 409,
    val errorResponse: FlightsV3Errors?,
    requestId: UUID?,
    message: String?,
...
class GetFlightDetails429Exception(
    code: Int = 429,
    val errorResponse: FlightsV3APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightDetails500Exception(
    code: Int = 500,
    val errorResponse: FlightsV3Errors?,
    requestId: UUID?,
    message: String?,
...
class GetFlightDetails503Exception(
    code: Int = 503,
    val errorResponse: FlightsV3APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightDetails504Exception(
    code: Int = 504,
