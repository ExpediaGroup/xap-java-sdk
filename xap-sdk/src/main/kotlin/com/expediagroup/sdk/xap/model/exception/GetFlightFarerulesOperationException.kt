...
class GetFlightFarerules400Exception(
    code: Int = 400,
...
class GetFlightFarerules401Exception(
    code: Int = 401,
...
class GetFlightFarerules403Exception(
    code: Int = 403,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightFarerules404Exception(
    code: Int = 404,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightFarerules429Exception(
    code: Int = 429,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightFarerules500Exception(
    code: Int = 500,
    val errorResponse: FlightsV1Errors?,
    requestId: UUID?,
    message: String?,
...
class GetFlightFarerules503Exception(
    code: Int = 503,
    val errorResponse: APIMError?,
    requestId: UUID?,
    message: String?,
...
class GetFlightFarerules504Exception(
    code: Int = 504,
