...
class GetLodgingDetails400Exception(
    code: Int = 400,
...
class GetLodgingDetails401Exception(
    code: Int = 401,
...
class GetLodgingDetails403Exception(
    code: Int = 403,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingDetails429Exception(
    code: Int = 429,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingDetails500Exception(
    code: Int = 500,
    val errorResponse: Errors?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingDetails503Exception(
    code: Int = 503,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingDetails504Exception(
    code: Int = 504,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
