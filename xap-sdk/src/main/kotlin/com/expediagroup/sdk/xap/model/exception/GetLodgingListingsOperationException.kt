...
class GetLodgingListings400Exception(
    code: Int = 400,
...
class GetLodgingListings401Exception(
    code: Int = 401,
...
class GetLodgingListings403Exception(
    code: Int = 403,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingListings429Exception(
    code: Int = 429,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingListings500Exception(
    code: Int = 500,
    val errorResponse: Errors?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingListings503Exception(
    code: Int = 503,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
...
class GetLodgingListings504Exception(
    code: Int = 504,
    val errorResponse: APIGatewayError?,
    requestId: UUID?,
    message: String?,
