...
data class GetFeedDownloadUrlOperationParams private constructor(
    ...
    class Builder(
         ...
         */
        fun type(
            type: GetFeedDownloadUrlOperationParams.Type,
         ...
         */
        fun pointOfSupply(
            pointOfSupply: GetFeedDownloadUrlOperationParams.PointOfSupply,
         ...
         */
        fun lodgingType(
            lodgingType: GetFeedDownloadUrlOperationParams.LodgingType,
         ...
         */
        fun brand(
            brand: GetFeedDownloadUrlOperationParams.Brand,
