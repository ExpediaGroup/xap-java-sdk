 ...
 */
class GetFlightBagaggefeeOperation(
    private val params: GetFlightBagaggefeeOperationParams,
    ...
    override fun getTypeIdentifier(): TypeReference<FlightBaggageFeesResponse> = jacksonTypeRef()
    ...
    override fun getExceptionForCode(
        ...
        400 -> GetFlightBagaggefee400Exception(
            ...
            errorResponse = errorResponseStr?.let {
                try {
                    com.expediagroup.sdk.xap.core.mapper.XapJacksonObjectMapper.INSTANCE.readValue(errorResponseStr, FlightsV1Errors::class.java)
                } catch (e: Exception) {
                    null
                }
            },
