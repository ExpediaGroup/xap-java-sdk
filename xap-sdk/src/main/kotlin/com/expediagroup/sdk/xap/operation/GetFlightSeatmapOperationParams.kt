...
data class GetFlightSeatmapOperationParams private constructor(
    ...
    class Builder(
         ...
         */
        fun loyaltyProgramNumber(
            loyaltyProgramNumber: kotlin.String,
        ) = apply { this.loyaltyProgramNumber = loyaltyProgramNumber }
         ...
         */
        fun travelerFirstName(
            travelerFirstName: kotlin.String,
        ) = apply { this.travelerFirstName = travelerFirstName }
         ...
         */
        fun travelerLastName(
            travelerLastName: kotlin.String,
        ) = apply { this.travelerLastName = travelerLastName }
        ...
        fun build(): GetFlightSeatmapOperationParams {
            ...
            val params = GetFlightSeatmapOperationParams(
