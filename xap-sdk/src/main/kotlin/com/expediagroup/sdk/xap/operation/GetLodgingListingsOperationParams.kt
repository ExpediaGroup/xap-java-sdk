...
data class GetLodgingListingsOperationParams private constructor(
    ...
    class Builder(
         ...
         */
        fun ecomHotelIds(
            ecomHotelIds: kotlin.collections.Set<
                kotlin.String,
                >,
         ...
         */
        fun hcomHotelIds(
            hcomHotelIds: kotlin.collections.Set<
                kotlin.String,
                >,
         ...
         */
        fun unit(
            unit: GetLodgingListingsOperationParams.Unit,
         ...
         */
        fun regionIds(
            regionIds: kotlin.collections.Set<
                kotlin.String,
                >,
         ...
         */
        fun source(
            source: GetLodgingListingsOperationParams.Source,
         ...
         */
        fun contentDetails(
            contentDetails: GetLodgingListingsOperationParams.ContentDetails,
         ...
         */
        fun minStarRating(
            minStarRating: GetLodgingListingsOperationParams.MinStarRating,
         ...
         */
        fun maxStarRating(
            maxStarRating: GetLodgingListingsOperationParams.MaxStarRating,
         ...
         */
        fun availOnly(
            availOnly: kotlin.Boolean,
        ) = apply { this.availOnly = availOnly }

        /**
         * @param smokingPreference Specifies smoking preference.
         */
        fun smokingPreference(
            smokingPreference: GetLodgingListingsOperationParams.SmokingPreference,
         ...
         */
        fun rateType(
            rateType: GetLodgingListingsOperationParams.RateType,
         ...
         */
        fun imageSizes(
            imageSizes: GetLodgingListingsOperationParams.ImageSizes,
         ...
         */
        fun thumbnailImageSize(
            thumbnailImageSize: GetLodgingListingsOperationParams.ThumbnailImageSize,
         ...
         */
        fun includedPropertyTypeIds(
            includedPropertyTypeIds: kotlin.collections.Set<
                kotlin.String,
                >,
         ...
         */
        fun excludedPropertyTypeIds(
            excludedPropertyTypeIds: kotlin.collections.Set<
                kotlin.String,
                >,
         ...
         */
        fun includedInventorySourceIds(
            includedInventorySourceIds: kotlin.collections.Set<
                kotlin.String,
                >,
         ...
         */
        fun freeCancellation(
            freeCancellation: kotlin.Boolean,
         ...
         */
        fun groupedAmenities(
            groupedAmenities: kotlin.Boolean,
         ...
         */
        fun blockFullDepositRateplan(
            blockFullDepositRateplan: kotlin.Boolean,
         ...
         */
        fun ratePlanType(
            ratePlanType: GetLodgingListingsOperationParams.RatePlanType,
         ...
         */
        fun sortType(
            sortType: GetLodgingListingsOperationParams.SortType,
         ...
         */
        fun sortOrder(
            sortOrder: GetLodgingListingsOperationParams.SortOrder,
        ) = apply { this.sortOrder = sortOrder }

        fun rooms(rooms: List<com.expediagroup.sdk.xap.model.Room>) = apply {
