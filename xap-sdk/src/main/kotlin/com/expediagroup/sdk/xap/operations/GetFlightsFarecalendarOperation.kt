...
import com.expediagroup.sdk.xap.models.FareCalendarResponse
...
class GetFlightsFarecalendarOperation(
    private val params: GetFlightsFarecalendarOperationParams,
    ...
    override fun getUrlPath(): String {
        var url = "/flights/farecalendar"

        return url
    }

    override fun getTypeIdentifier(): TypeReference<FareCalendarResponse> = jacksonTypeRef()
