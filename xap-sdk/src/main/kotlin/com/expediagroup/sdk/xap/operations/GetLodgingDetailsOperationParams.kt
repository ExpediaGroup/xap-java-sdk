...
? = null
        ,
        @JsonProperty("imageSizes") private var imageSizes:     GetLodgingDetailsOperationParams.ImageSizes
...
? = null
    ...
    kotlin.String
        ...
        */
        fun imageSizes(imageSizes:     GetLodgingDetailsOperationParams.ImageSizes
    ...
    fun build(): GetLodgingDetailsOperationParams {
        val params = GetLodgingDetailsOperationParams(
