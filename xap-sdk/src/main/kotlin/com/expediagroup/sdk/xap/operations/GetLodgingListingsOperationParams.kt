...
import com.expediagroup.sdk.xap.models.HotelListingsResponse
    ...
    , 
                    val ecomHotelIds:         kotlin.collections.Set
    <
...
?
    = null
, 
                    val hcomHotelIds:         kotlin.collections.Set
    <
...
?
    = null
, 
                    val regionIds:         kotlin.collections.Set
    <
...
?
    = null
, 
                    val includedPropertyTypeIds:         kotlin.collections.Set
    <
...
?
    = null
, 
                    val excludedPropertyTypeIds:         kotlin.collections.Set
    <
...
?
    = null
, 
                    val includedInventorySourceIds:         kotlin.collections.Set
    <
...
?
    = null
, 
                    val groupedAmenities:     
    kotlin.Boolean

?
    = null
, 
                    val blockFullDepositRateplan:     
    kotlin.Boolean
...
? = null
        ,
        @JsonProperty("ecomHotelIds") private var ecomHotelIds:         kotlin.collections.Set
    <
...
? = null
        ,
        @JsonProperty("hcomHotelIds") private var hcomHotelIds:         kotlin.collections.Set
    <
...
? = null
        ,
        @JsonProperty("geoLocation") private var geoLocation:     
    kotlin.String
? = null
        ,
        @JsonProperty("radius") private var radius:     
    kotlin.Long
? = null
        ,
        @JsonProperty("unit") private var unit:     GetLodgingListingsOperationParams.Unit
    
? = null
        ,
        @JsonProperty("locationKeyword") private var locationKeyword:     
    kotlin.String
? = null
        ,
        @JsonProperty("regionIds") private var regionIds:         kotlin.collections.Set
    <
...
? = null
        ,
        @JsonProperty("checkIn") private var checkIn:     
    java.time.LocalDate
? = null
        ,
        @JsonProperty("checkOut") private var checkOut:     
    java.time.LocalDate
? = null
        ,
...
? = null
        ,
        @JsonProperty("source") private var source:     GetLodgingListingsOperationParams.Source
    
? = null
        ,
        @JsonProperty("travelWithPets") private var travelWithPets:     
    kotlin.Boolean
? = null
        ,
        @JsonProperty("contentDetails") private var contentDetails:     GetLodgingListingsOperationParams.ContentDetails
    
? = null
        ,
        @JsonProperty("allRoomTypes") private var allRoomTypes:     
    kotlin.Boolean
? = null
        ,
...
? = null
        ,
        @JsonProperty("minStarRating") private var minStarRating:     GetLodgingListingsOperationParams.MinStarRating
    
? = null
        ,
        @JsonProperty("maxStarRating") private var maxStarRating:     GetLodgingListingsOperationParams.MaxStarRating
    
? = null
        ,
        @JsonProperty("limit") private var limit:     
    kotlin.Long
? = null
        ,
        @JsonProperty("queryText") private var queryText:     
    kotlin.String
? = null
        ,
        @JsonProperty("availOnly") private var availOnly:     
    kotlin.Boolean
? = null
        ,
        @JsonProperty("smokingPreference") private var smokingPreference:     GetLodgingListingsOperationParams.SmokingPreference
    
? = null
        ,
        @JsonProperty("rateType") private var rateType:     GetLodgingListingsOperationParams.RateType
    
? = null
        ,
        @JsonProperty("imageSizes") private var imageSizes:     GetLodgingListingsOperationParams.ImageSizes
    
? = null
        ,
        @JsonProperty("thumbnailImageSize") private var thumbnailImageSize:     GetLodgingListingsOperationParams.ThumbnailImageSize
    
? = null
        ,
        @JsonProperty("includedPropertyTypeIds") private var includedPropertyTypeIds:         kotlin.collections.Set
    <
...
? = null
        ,
        @JsonProperty("excludedPropertyTypeIds") private var excludedPropertyTypeIds:         kotlin.collections.Set
    <
...
? = null
        ,
        @JsonProperty("includedInventorySourceIds") private var includedInventorySourceIds:         kotlin.collections.Set
    <
...
? = null
        ,
        @JsonProperty("freeCancellation") private var freeCancellation:     
    kotlin.Boolean
? = null
        ,
        @JsonProperty("groupedAmenities") private var groupedAmenities:     
    kotlin.Boolean
? = null
        ,
        @JsonProperty("blockFullDepositRateplan") private var blockFullDepositRateplan:     
    kotlin.Boolean
? = null
        ,
        @JsonProperty("ratePlanType") private var ratePlanType:     GetLodgingListingsOperationParams.RatePlanType
    
? = null
        ,
        @JsonProperty("sortType") private var sortType:     GetLodgingListingsOperationParams.SortType
    
? = null
        ,
        @JsonProperty("sortOrder") private var sortOrder:     GetLodgingListingsOperationParams.SortOrder
    
? = null
        ,
        @JsonProperty("room1.adults") private var room1Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room2.adults") private var room2Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room3.adults") private var room3Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room4.adults") private var room4Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room5.adults") private var room5Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room6.adults") private var room6Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room7.adults") private var room7Adults:     
    kotlin.Long
? = null
        ,
...
? = null
        ,
        @JsonProperty("room8.adults") private var room8Adults:     
    kotlin.Long
? = null
        ,
...
? = null
    ...
    kotlin.String
        ...
        */
        fun ecomHotelIds(ecomHotelIds:         kotlin.collections.Set
    <
        
        kotlin.String
    >
) = apply { this.ecomHotelIds = ecomHotelIds }
        /**
        * @param hcomHotelIds Comma-separated list of Hotels.com hotel IDs. There can be no spaces between parameters.
        */
        fun hcomHotelIds(hcomHotelIds:         kotlin.collections.Set
    <
        
        kotlin.String
    >
) = apply { this.hcomHotelIds = hcomHotelIds }
        /**
    ...
    kotlin.Long
        ...
        */
        fun unit(unit:     GetLodgingListingsOperationParams.Unit
        ...
        */
        fun locationKeyword(locationKeyword:     
    kotlin.String
) = apply { this.locationKeyword = locationKeyword }
        /**
        ...
        */
        fun regionIds(regionIds:         kotlin.collections.Set
    <
        
        kotlin.String
    >
) = apply { this.regionIds = regionIds }
        /**
    ...
    kotlin.String
        ...
        */
        fun source(source:     GetLodgingListingsOperationParams.Source
    ...
    kotlin.Boolean
) = apply { this.travelWithPets = travelWithPets }
        /**
        * @param contentDetails This parameter is optional and can be specified as the following values. - lowest - low (default) - medium - high  ### *lowest* Returns the absolute minimum response for up to 1,000 hotels: - Count(Count of hotels that are actually returned) - TotalHotelCount(Count of hotels that are requested) - TransactionId - StayDates - LengthOfStay - NumberOfRooms - Occupants - ***Hotels***   - Id   - Status   - Links   - ***RoomTypes***     - RoomKey [Deprecated]     - OfferId     - RatePlanType     - ***RatePlans***       - RoomTypeId       - RatePlanId       - RateRuleId       - InventorySourceId       - RemainingCount       - Price       - MemberOnlyDeal       - Promotions       - PaymentMethod       - FullDepositUponBooking       - PaymentSchedule       - CancellationPolicy     - Price       - BaseRate       - TaxesAndFees       - TotalPrice       - TotalStrikeOutPrice       - AvgNightlyRate       - AvgNightlyStrikeOutRate       - AvgNightlyRateWithFees       - AvgNightlyStrikeOutRateWithFees       - HotelMandatoryFees       - TotalPriceWithHotelFees       - NightlyRates       - TaxesAndFeesDetails       - RefundableDamageDeposit  This minimal response is the best for partners that store static hotel location data locally, and who would like to have the smallest and fastest API response.  ### *low* Returns basic hotel information in response for up to 1,000 hotels.  Includes all elements returned when `contentDetails=lowest` plus: - ***Hotels***   - Name   - PropertyType   - PropertyDetails   - LocalCurrencyCode   - Location   - Distance   - Description(may not be localized)   - ChainAndBrandInfo   - ThumbnailUrl   - StarRating   - GuestRating   - GuestReviewCount   - PetFriendly   - LgbtqiaFriendly   - ImportantNotices   - ***RoomTypes***     - Description     - ***RatePlans***       - InventorySourceCode       - PaymentTime       - ReserveWithDeposit       - FreeInternet       - FreeWiFi       - FreeParking       - FreeBreakfast                    ### *medium* Returns more complete hotel information in response for up to 200 hotels.  Includes all elements returned when `contentDetails=low` plus: - ***Hotels***   - HotelAmenities   - RoomAmenities   - ***RoomTypes***     - ***RatePlans***       - FreeInternetDetails       - FreeBreakfastDetails       - Amenities     - Amenities  **Note**: Setting the `contentDetails` to `medium` will automatically limit your response size to 200 hotels.  ### *high* Returns extended hotel information in response for up to 5 hotels.  Includes all elements returned when `contentDetails=medium` plus: - ***Hotels***   - RenovationsAndClosures   - Policies   - OptionalExtras   - Media   - Accessibility   - ***RoomTypes***     - SmokingOption     - BedTypeOptions     - RoomOccupancyPolicy     - Media  **Note**: Setting the `contentDetails` to `high` will automatically limit your response size to 5 hotels. 
        */
        fun contentDetails(contentDetails:     GetLodgingListingsOperationParams.ContentDetails
    
) = apply { this.contentDetails = contentDetails }
        /**
        ...
        */
        fun allRoomTypes(allRoomTypes:     
    kotlin.Boolean
) = apply { this.allRoomTypes = allRoomTypes }
        /**
        * @param links  Comma-separated list to specify the types of deep links. - WD (link to Web Details site) - WS (link to Web Search Result page) - AD (link for Details API) - RC (link for RateCalendar API) - WEB (include all website links) - API (links for Details and RateCalendar API)  There are two level of links returned in the API response: Property-level deeplinks and room-level deeplinks.  When requesting API deeplinks you will receive both a RateCalendar API link at the property level, and Details API links at the room level, since the Lodging Details API only displays information on rate plan offers.  When requesting AD deeplinks, you will <u>only</u> receive Details API links at the room level. `Links` node in property-level will be omitted.  If you are looking for more complete details on a single property via the API, you should do another search in the Lodging API for the single Hotel ID, with `contentDetails=high` to get all details back in return (note that you can only get back a maximum of 5 hotels when `contentDetails` is set to `high`).  **NOTE**: dateless searches will not return Details API links, since the Lodging Details API will only return details on a specific room offer for specific dates. 
        */
        fun links(links:         kotlin.collections.List
    <
        GetLodgingListingsOperationParams.Links
    ...
    >
        ...
        */
        fun minStarRating(minStarRating:     GetLodgingListingsOperationParams.MinStarRating
    
) = apply { this.minStarRating = minStarRating }
        /**
        * @param maxStarRating The maximum star rating for hotels returned in the response.
        */
        fun maxStarRating(maxStarRating:     GetLodgingListingsOperationParams.MaxStarRating
    
) = apply { this.maxStarRating = maxStarRating }
        /**
    ...
    kotlin.String
) = apply { this.queryText = queryText }
        /**
        ...
        */
        fun availOnly(availOnly:     
    kotlin.Boolean
) = apply { this.availOnly = availOnly }
        /**
        * @param smokingPreference Specifies smoking preference.
        */
        fun smokingPreference(smokingPreference:     GetLodgingListingsOperationParams.SmokingPreference
    
) = apply { this.smokingPreference = smokingPreference }
        /**
        * @param rateType Indicate which type of `paymentMethod` for each room will be returned.
        */
        fun rateType(rateType:     GetLodgingListingsOperationParams.RateType
    
) = apply { this.rateType = rateType }
        /**
        ...
        */
        fun imageSizes(imageSizes:     GetLodgingListingsOperationParams.ImageSizes
    
) = apply { this.imageSizes = imageSizes }
        /**
        ...
        */
        fun thumbnailImageSize(thumbnailImageSize:     GetLodgingListingsOperationParams.ThumbnailImageSize
    
) = apply { this.thumbnailImageSize = thumbnailImageSize }
        /**
        ...
        */
        fun includedPropertyTypeIds(includedPropertyTypeIds:         kotlin.collections.Set
    <
        
        kotlin.String
    >
) = apply { this.includedPropertyTypeIds = includedPropertyTypeIds }
        /**
        ...
        */
        fun excludedPropertyTypeIds(excludedPropertyTypeIds:         kotlin.collections.Set
    <
        
        kotlin.String
    >
) = apply { this.excludedPropertyTypeIds = excludedPropertyTypeIds }
        /**
        * @param includedInventorySourceIds Querying with no `includedInventorySourceIds` parameter will return listings from all available inventory sources.  Query with the `includedInventorySourceIds` parameter included will only return listings from the requested inventory sources. All others will be left out.  `includedInventorySourceId=24` will return only Expedia lodging inventory.  `includedInventorySourceId=83` will return only Vrbo lodging inventory.  `includedInventorySourceId=24,83` will return both Expedia and Vrbo lodging inventory. 
        */
        fun includedInventorySourceIds(includedInventorySourceIds:         kotlin.collections.Set
    <
        
        kotlin.String
    >
) = apply { this.includedInventorySourceIds = includedInventorySourceIds }
        /**
        ...
        */
        fun freeCancellation(freeCancellation:     
    kotlin.Boolean
) = apply { this.freeCancellation = freeCancellation }
        /**
        ...
        */
        fun groupedAmenities(groupedAmenities:     
    kotlin.Boolean
) = apply { this.groupedAmenities = groupedAmenities }
        /**
        ...
        */
        fun blockFullDepositRateplan(blockFullDepositRateplan:     
    kotlin.Boolean
) = apply { this.blockFullDepositRateplan = blockFullDepositRateplan }
        /**
        * @param ratePlanType **Note**: This parameter is visible to partners only by configuration. Please contact your Expedia Account Manager if you need this parameter.  To specify the desired rate plan types. The options are: - standalone : Ask for standalone rates - package : Ask for package rates, but standalone rate also may be returned if available.  Otherwise only standalone rate plans will be returned.  `WebSearchResult` and `WebDetails` links won't be returned for package rate. 
        */
        fun ratePlanType(ratePlanType:     GetLodgingListingsOperationParams.RatePlanType
    
) = apply { this.ratePlanType = ratePlanType }
        /**
        ...
        */
        fun sortType(sortType:     GetLodgingListingsOperationParams.SortType
        ...
        */
        fun sortOrder(sortOrder:     GetLodgingListingsOperationParams.SortOrder
...
return Headers.builder().apply {
    ...
    buildList {
        ...
        val key = "blockFullDepositRateplan"
        val value = buildList {
            add(it.toString())
        }
